...
public class TabelaLekova2 extends JPanel
{
    ...
    public static void newFilter() {
        ...
        try {
        	rf= RowFilter.regexFilter("(?i)"+LekoviWin2.srch.getText(), 0,1,3);
    ...
    public static void newFilter2() {
    	...
    	try {
    		int odInt= Integer.parseInt(LekoviWin2.od2.getText());
    		int doInt= Integer.parseInt(LekoviWin2.do2.getText());
